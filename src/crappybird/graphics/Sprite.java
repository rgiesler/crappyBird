...
public class Sprite {
	...
	// Scoring
	public static Sprite scoreBoard = new Sprite(SpriteSheet.tiles, 146, 58,
			113, 58, 0xE4005F);
	public static Sprite gameOver = new Sprite(SpriteSheet.tiles, 146, 199, 94,
			19, 0xE4005F);

	// Medals
	public static Sprite medalPlatinum = new Sprite(SpriteSheet.tiles, 220,
			144, 22, 22, 0xE4005F);
	public static Sprite medalBronze = new Sprite(SpriteSheet.tiles, 302, 137,
			22, 22, 0xE4005F);
	public static Sprite medalGold = new Sprite(SpriteSheet.tiles, 242, 229,
			22, 22, 0xE4005F);
	public static Sprite medalSilver = new Sprite(SpriteSheet.tiles, 266, 229,
			22, 22, 0xE4005F);

	// Misc
	public static Sprite tap = new Sprite(SpriteSheet.tiles, 171, 121, 40, 50,
			0xE4005F);
	public static Sprite title = new Sprite(SpriteSheet.tiles, 146, 173, 96,
			22, 0xE4005F);
	public static Sprite newHigh = new Sprite(SpriteSheet.tiles, 146, 246, 16,
			7, 0xE4005F);
	public static Sprite okay = new Sprite(SpriteSheet.tiles, 246, 134, 40, 14,
			0xE4005F);
